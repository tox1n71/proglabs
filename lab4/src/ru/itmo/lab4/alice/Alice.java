...
import ru.itmo.lab4.myexceptions.AlicesNameException;
...
public class Alice {
    ...
    public Alice(String name) throws AlicesNameException {
        if(name != "Алиса") throw new AlicesNameException("некорректное имя главного героя");
        this.name = name;
    }
