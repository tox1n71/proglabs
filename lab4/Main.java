...
public class Main {
        public static void main(String[] args) throws MyExceptions.ScenerioException {
                try {
                        ...
                        SmallDoor smallDoor = new SmallDoor("маленькая дверца", "]][][[][", "сантиметров 30 высотой");
                        Place strangePlace = new Place("cтранное место") {
                        }; // Анонимный класс, наследник абстрактного класса Place
                        ...
                        throw new MyExceptions().new ScenerioException();
                }
        }
}
